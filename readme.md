...
## Running mountainsort.ipynb
 - Make a subfolder in your experiment's directory named 'dataset'
 - Add your raw.mda, geom.csv, and params.json files to the dataset folder
 - Copy mountainsort.ipynb to the experiment directory (1 level above "dataset" directory)
 ...
 - If it runs with no errors, delete any files in the datasets subfolder, copy over your raw.mda, geom.csv, and params.json files to the dataset folder, clear the kernal and retart the script (shut it down if you have to then reopen).
